    ...
    <DescriptionContainer>
        ...
        <DescriptionList>
            <DescriptionItem>
                ...
                <DescriptionItemText> <DescriptionItemSpan>Create a personal library:</DescriptionItemSpan> add <br />the books you intend to read <br /> to it.</DescriptionItemText>
            </DescriptionItem>
            <DescriptionItem>
