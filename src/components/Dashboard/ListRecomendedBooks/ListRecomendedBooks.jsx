...
import {
  ...
  ListRecomendedBooksName,
  ListRecomendedBooksNavLink,
  ListRecomendedBooksTitle,
  ListRecomendedBooksUl,
  ListRecomendedBooksWriter,
} from "./ListRecomendedBooks.styled";
    ...
    <ListRecomendedBooksContainer>
      ...
      <ListRecomendedBooksUl>
        {randomBooks.map((book) => (
          <ListRecomendedBooksLi key={book._id}>
            <ListRecomendedBooksImg
              src={book.imageUrl}
              alt={book.title}
              width="100"
      ...
      <ListRecomendedBooksLinkContainer>
        <ListRecomendedBooksNavLink to="/recommended">
          Home
        </ListRecomendedBooksNavLink>
        <ListRecomendedBooksLogoSpan>
          <ListRecomendedBooksIcon
